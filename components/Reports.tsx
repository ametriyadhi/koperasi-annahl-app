                ...
                <Card title="Neraca (Balance Sheet)">
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium text-sm text-gray-600 my-1">Liabilitas</p>
                            {liabilitas.map(a => <ReportRow key={a.kode} label={a.nama} value={a.saldo} indent />)}
                             <ReportRow label="Total Liabilitas" value={totalLiabilitas} isTotal indent/>
                             <p className="font-medium text-sm text-gray-600 my-1 mt-3">Ekuitas</p>
                            {ekuitas.map(a => <ReportRow key={a.kode} label={a.nama} value={a.saldo} indent />)}
                            <ReportRow label="Total Ekuitas" value={totalEkuitas} isTotal indent/>
